...
{
    /// <summary>
    /// Handles user registration and authentication (JWT token generation).
    /// </summary>
    public class AuthService : IAuthService
    {
        ...
        /// <summary>
        /// Registers a new user with the default "Contributor" role.
        /// </summary>
        public async Task<bool> RegisterAsync(RegisterDto dto, Guid? createdBy = null)
        {
            ...
            // Set self references for users who register themselves
            if (createdBy == null)
            {

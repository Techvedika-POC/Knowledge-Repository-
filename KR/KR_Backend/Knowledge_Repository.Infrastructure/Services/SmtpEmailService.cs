...
namespace Knowledge_Repository.Infrastructure.Services
{
    public class SmtpEmailService : IEmailService
    {
        ...
        public async Task SendEmailAsync(string toEmail, string subject, string htmlBody)
        {
            ...
            // parse To addresses safely (single address expected)
            ...
            var bodyBuilder = new BodyBuilder
            {
                ...
                TextBody = StripHtml(htmlBody) // optional text fallback
            };
            ...
            catch (Exception ex)
            {
                ...
                throw; // rethrow so caller knows send failed (or catch upstream)
            }
            finally
            {
        ...
        public async Task SendEmailBulkAsync(IEnumerable<string> toEmails, string subject, string htmlBody)
        {
            ...
            // Option: send individually to keep recipients private and have per-recipient logs/errors.
        ...
        // Minimal HTML stripper for text fallback. Keep simple.
        private static string StripHtml(string? html)
        {
            if (string.IsNullOrEmpty(html)) return string.Empty;
            // crude but practical: remove tags

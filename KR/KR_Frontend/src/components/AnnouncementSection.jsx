...
export default function AnnouncementSection({ showLatestOnly = true }) {
  ...
  return (
    <div className="w-full mt-8">
      {/* main announcement card – styled like other app cards */}
      <article className="w-full rounded-[32px] bg-gradient-to-br from-[#EFEAFF] to-[#E3F0FF] shadow-xl border border-slate-200 px-10 py-8">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          ...
          <div className="max-w-3xl">
            <h3 className="text-[22px] font-semibold text-sky-700 mb-6 px-6 py-2 
        ...
        <div className="mt-6">
          <button
            ...
            className="inline-flex items-center justify-center px-8 py-2 rounded-full text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700 shadow-md transition"
          >
            {expanded ? "Hide Details & Timeline" : "View Details & Timeline"}
          </button>
        </div>

        {/* inline timeline/details as card-style blocks */}
...
/* -------- TIMELINE + DETAILS SECTION (card style) -------- */
...
/* -------- Optional multi-announcement list (if used elsewhere) -------- */

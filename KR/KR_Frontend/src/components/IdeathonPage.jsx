      ...
      <header className="rounded-2xl p-6 bg-gradient-to-r from-indigo-50 via-sky-50 to-emerald-50 shadow-sm">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1 max-w-2xl leading-snug">
              Browse ideathons — switch between{" "}
              <span className="font-semibold text-sky-600 leading-none align-middle">
                Current
              </span>,{" "}
              <span className="font-semibold text-gray-600 leading-none align-middle">
                Past
              </span>{" "}
              or{" "}
              <span className="font-semibold text-indigo-600 leading-none align-middle">
                All
              </span>.
  ...
  return (
    <div className={`rounded-2xl p-6 shadow-md border bg-white ${fullWidth ? "" : ""}`}>
      <div className="flex flex-col md:flex-row items-start justify-between gap-4">
        ...
        <button
          onClick={onBack}
          className="px-3 py-1.5 rounded-full border text-sm text-gray-700 hover:bg-gray-50"
          type="button"
        >
          ← Back
        </button>
          ...
          <div className="mt-3">
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="mt-3 flex items-center gap-2">
                ...
                />
                <button onClick={handleSendChat} disabled={postingChat} className="px-4 py-1 rounded-md bg-green-600 text-white" type="button">
                  {postingChat ? "Sending..." : "Send"}
                </button>
                <button onClick={() => {
                  const tid = teamId || insight?.teamId;
                  if (tid) fetchTeamChat(tid);
                }} className="px-3 py-1 rounded-md border text-sm" type="button">Refresh</button>
              </div>
            </div>
          </div>
        )}

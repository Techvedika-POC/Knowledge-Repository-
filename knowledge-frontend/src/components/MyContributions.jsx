      ...
      >
        ...
        {searchType === "Domain" ? (
          <select
            ...
            className="border rounded px-2 py-1 flex-1 bg-white text-sm"
          >
          ...
          <input
            ...
            value={keyword}
            onChange={(e) => setKeyword(e.target.value)}
            className="border rounded px-2 py-1 flex-1 text-sm bg-white"
          />
        )}

        <button
          type="submit"
          className="px-3 py-1 rounded text-blue-700 border border-gray-200 hover:bg-blue-50 flex items-center gap-1"
        >
          ...
          <tbody>
            {contributions.map((c) => (
              <tr key={c.itemId} className="border-t hover:bg-gray-50 relative">
                ...
                <td className="px-2 py-1">
                  <button
                    className="px-2 py-1 text-blue-700 border border-gray-200 rounded text-xs hover:bg-blue-50"
                    onClick={() => openModal(c)}
                  >
                    Preview
                  </button>
...
{hoveredItem && hoveredItem.visible && (
  <div
    ...
    style={{
      top: hoveredItem.y + 10 + window.scrollY + "px",

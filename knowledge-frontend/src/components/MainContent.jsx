...
//     }
//   };
//   const tabColors = ["bg-pink-200 text-pink-800 hover:bg-pink-300", "bg-green-200 text-green-800 hover:bg-green-300", "bg-blue-200 text-blue-800 hover:bg-blue-300"];
...
//               <div
//                 key={index}
//                 className="rounded-2xl p-5 shadow-sm bg-gray-50 hover:shadow-md transition-all flex flex-col gap-3 border border-gray-100"
//               >
...
//               <div
//                 key={idx}
//                 className="rounded-2xl p-5 shadow-sm bg-gray-50 hover:shadow-md transition-all flex flex-col gap-2 border border-gray-100"
//               >
...
//               <p className="text-md text-gray-700">
//                 {ideathonEvent.description.length > 100 ? ideathonEvent.description.substring(0, 100) + "..." : ideathonEvent.description}
//               </p>
//             </div>
//           )}
//         </div>
...
//               className="px-5 py-2 text-sm font-semibold text-gray-800 bg-gray-200 hover:bg-gray-300 rounded-lg transition-colors"
//             >
